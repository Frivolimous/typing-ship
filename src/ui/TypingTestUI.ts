...
import { TypingTestResultUI } from './elements/TypingTestResultUI';
...
export class TypingTestUI extends BaseUI {
  ...
  constructor() {
    ...
    this.topText = new PIXI.Text(CONTENT, {fontSize: 24, fontFamily: Fonts.UI, fill: 0xeedd11, wordWrap: true, wordWrapWidth: CONFIG.INIT.SCREEN_WIDTH - 100});
    this.topText.position.set(50, 50);
    this.topTextOver = new PIXI.Text('', {fontSize: 24, fontFamily: Fonts.UI, fill: 0xff5511, wordWrap: true, wordWrapWidth: CONFIG.INIT.SCREEN_WIDTH - 100});
    this.topTextOver.position.set(50, 50);

    this.bottomText = new PIXI.Text('', {fontSize: 24, fontFamily: Fonts.UI, fill: 0xff5511, wordWrap: true, wordWrapWidth: CONFIG.INIT.SCREEN_WIDTH - 100});
